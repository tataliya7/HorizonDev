...
namespace HE
{
    ...
    struct RenderBackendCommandTraceRays : RenderBackendCommand<RenderBackendCommandType::TraceRays, RenderBackendCommandQueueType::Graphics>
    {
    ...
    {
        uint32 numViewports;
        RenderBackendViewport viewports[RenderBackendMaxNumViewports];
    };
    ...
    {
        uint32 numScissors;
        RenderBackendScissor scissors[RenderBackendMaxNumViewports];
    };
    ...
    struct RenderBackendCommandEvaluateDLSS : RenderBackendCommand<RenderBackendCommandType::EvaluateDLSS, RenderBackendCommandQueueType::Graphics>
    {
    ...
    struct RenderBackendCommandFSR2Dispatch : RenderBackendCommand<RenderBackendCommandType::FSR2Dispatch, RenderBackendCommandQueueType::Compute>
    {
        RenderBackendTextureHandle output;
        RenderBackendTextureHandle color;
        RenderBackendTextureHandle depth;
