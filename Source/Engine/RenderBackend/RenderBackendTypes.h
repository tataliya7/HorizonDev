...
namespace HE
{
    ...
    static_assert((uint32)RenderBackendQueueFamily::Graphics == 2, "Default graphics queue index should be 2.");
    static_assert((uint32)RenderBackendQueueFamily::Count == RENDER_BACKEND_NUM_QUEUE_FAMILIES);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendResourceStateFlags);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendBufferCreateFlags);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendTextureCreateFlags);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendColorComponentFlags);
    ...
    struct RenderBackendTextureSRVDesc
    {
        ...
        {
            return RenderBackendTextureSRVDesc(texture, 0, RENDER_BACKEND_REMAINING_MIP_LEVELS, 0, RENDER_BACKEND_REMAINING_ARRAY_LAYERS);
        }
    ...
    struct RenderBackendColorBlendAttachmentState
    {
        ...
        RenderBackendColorComponentFlags  colorWriteMask = RenderBackendColorComponentFlags::RGBA;
    };

    struct RenderBackendColorBlendState
    {
        RenderBackendColorBlendAttachmentState targetBlends[RenderBackendMaxNumSimultaneousColorRenderTargets];
    };
    ...
    struct RenderBackendRenderPassInfo
    {
        ...
        ColorRenderTarget colorRenderTargets[RenderBackendMaxNumSimultaneousColorRenderTargets];
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendRayTracingAccelerationStructureBuildFlags);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendRayTracingInstanceFlags);
    ...
    HE_ENUM_CLASS_OPERATORS(RenderBackendRayTracingGeometryFlags);
