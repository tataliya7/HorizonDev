...
namespace HE
{
    ...
    static_assert(ARRAY_SIZE(GVkFormatTable) == (uint32)RenderBackendTextureFormat::Count);
    ...
    static inline VkAttachmentLoadOp ConvertToVkAttachmentLoadOp(RenderBackendRenderTargetLoadOp loadOp)
    {
        switch (loadOp)
        {
        case RenderBackendRenderTargetLoadOp::DontCare: return VK_ATTACHMENT_LOAD_OP_DONT_CARE;
        case RenderBackendRenderTargetLoadOp::Load: return VK_ATTACHMENT_LOAD_OP_LOAD;
        case RenderBackendRenderTargetLoadOp::Clear: return VK_ATTACHMENT_LOAD_OP_CLEAR;
        default: std::unreachable(); return VK_ATTACHMENT_LOAD_OP_MAX_ENUM;
        }
    }

    static inline VkAttachmentStoreOp ConvertToVkAttachmentStoreOp(RenderBackendRenderTargetStoreOp storeOp)
    {
        switch (storeOp)
        {
        case RenderBackendRenderTargetStoreOp::DontCare: return VK_ATTACHMENT_STORE_OP_DONT_CARE;
        case RenderBackendRenderTargetStoreOp::Store: return VK_ATTACHMENT_STORE_OP_STORE;
