...
namespace HE
{
    ...
    public:
        ...
        template <typename T>
        FORCEINLINE T* AllocateCommand(RenderBackendCommandType type, uint64 size = sizeof(T))
        {
    ...
    public:
        ...
        void Dispatch2D(RenderBackendShaderHandle shader, const RenderBackendShaderArguments& shaderArguments, uint32 x, uint32 y);
        ...
        void TraceRays(RenderBackendRayTracingPipelineStateHandle pipelineState, RenderBackendBufferHandle shaderBindingTable, const RenderBackendShaderArguments& shaderArguments, uint32 x, uint32 y, uint32 z);
        // Graphics commands
