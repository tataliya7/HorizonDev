        ...
        const SceneView& view)
    {
        ...
        renderGraph.AddPass(std::format("LocalLightShadows (Graphics, {}x{}, {} viewports)", localLightShadowMapAtlasSize, localLightShadowMapAtlasSize, numViewports), RenderGraphPassFlags::Graphics,
            [&](RenderGraphBuilder& builder)
            {
                ...
                builder.BindDepthTarget(localLightShadowMapAtlas, RenderBackendRenderTargetLoadOp::Clear, RenderBackendRenderTargetStoreOp::Store);
                ...
                return [=](RenderGraphRegistry& registry, RenderBackendCommandList& commandList)
                {
                    ...
                    for (const auto& drawCallInfo : renderEngine->drawList)
                    {
                        ...
                        RenderBackendShaderHandle graphicsShader = shaderLibrary->GetShaderHandle((uint32)RealTimeRendererShaderPiplineID::LocalLightShadows);
