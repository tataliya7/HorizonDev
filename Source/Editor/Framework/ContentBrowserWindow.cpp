...
//        if (!deleted)
//        {
//            LogError(GLogger, std::format(("Failed to delete {0}", item.path.string())));
//            return;
//        }
//        switch (item.GetType())
//        {
...
//{
//    fileIcon = Texture::Create2DFromFile("../../../Assets/Icons/file.png");
//    directoryIcon = Texture::Create2DFromFile("../../../Assets/Icons/folder.png");
//    backButtonIcon = Texture::Create2DFromFile("../../../Assets/Icons/btn_back.png");
//    forwardButtonIcon = Texture::Create2DFromFile("../../../Assets/Icons/btn_fwrd.png");
//    refreshButtonIcon = Texture::Create2DFromFile("../../../Assets/Icons/refresh.png");
//
//
//    AssetIconMap[".fbx"] = Texture::Create2DFromFile("../../../Assets/Icons/fbx.png");
//    AssetIconMap[".obj"] = Texture::Create2DFromFile("../../../Assets/Icons/obj.png");
//    AssetIconMap[".wav"] = Texture::Create2DFromFile("../../../Assets/Icons/wav.png");
//    AssetIconMap[".cs"] = Texture::Create2DFromFile("../../../Assets/Icons/cs.png");
//    AssetIconMap[".png"] = Texture::Create2DFromFile("../../../Assets/Icons/png.png");
//    AssetIconMap[".hmaterial"] = Texture::Create2DFromFile("../../../Assets/Icons/MaterialAssetIcon.png");
//    AssetIconMap[".hscene"] = Texture::Create2DFromFile("../../../Assets/Icons/hazel.png");
//
//    UUID uuid = ProcessDirectory("../../../Assets", nullptr);
