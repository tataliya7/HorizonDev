...
void DrawNode(ImNodesEditorContext& editor, const int node_idx)
{
    ...
    else if (node_hovered)
    {
        ...
        node_outline = node.ColorStyle.OutlineHovered;
    }
...
void BeginNode(const int node_id, unsigned int color)
{
    ...
    node.ColorStyle.Titlebar = color;
    node.ColorStyle.TitlebarHovered = color;
    node.ColorStyle.TitlebarSelected = color;
