...
module FidelityFX.FSR2:Private;
...
namespace Horizon
{
    ...
    class FidelityFXFSR2 : public TemporalSuperSamplingInterface
    {
    public:
        FidelityFXFSR2(RenderBackend* renderBackend);
        virtual ~FidelityFXFSR2();
