...
export module Horizon.Rendering.RenderBackend;

export namespace Horizon::Experimental
{
    enum
    {
        RenderBackendMaxDeviceCount = 16,
        RenderBackendMaxViewportCount = 16,
        RenderBackendMaxRenderTargetCount = 8,
        RenderBackendMaxSwapChainBufferCount = 8,
