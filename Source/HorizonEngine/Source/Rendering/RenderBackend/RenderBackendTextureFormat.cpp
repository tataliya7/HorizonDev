...
namespace Horizon
{
    static const RenderBackendTextureFormatDesc GRenderBackendTextureFormatDescs[] =
    {
    ...
    static_assert(((uint32)(sizeof(GRenderBackendTextureFormatDescs) / sizeof(*(GRenderBackendTextureFormatDescs)))) == (uint32)RenderBackendTextureFormat::Count);

    const RenderBackendTextureFormatDesc& RenderBackendGetTextureFormatDesc(RenderBackendTextureFormat format)
    {
        return GRenderBackendTextureFormatDescs[(uint32)format];
    }
}