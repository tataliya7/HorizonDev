...
#define DEFINE_VULKAN_FUNCTION(function) PFN_##function function;
    ...
    public:
        ...
        uint32 CreateRayTracingBottomLevelAccelerationStructure(const RenderBackendRayTracingBottomLevelAccelerationStructureDescription* desc, const char* name);
        uint32 CreateRayTracingTopLevelAccelerationStructure(const RenderBackendRayTracingTopLevelAccelerationStructureDescription* desc, const char* name);
    ...
    public:
        ...
        bool TranslateRenderBackendCommands(const RenderBackendCommandContainer& container);
        bool TranslateRenderBackendCommand(const RenderBackendCommandCopyBuffer& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandCopyTexture& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandUpdateBuffer& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandUpdateTexture& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandClearBufferUAV& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandClearTextureUAV& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBarriers& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBeginTimingQuery& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandEndTimingQuery& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandResolveTimingQueryResults& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatch& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatchIndirect& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandSetViewport& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandSetScissor& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandSetStencilReference& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBeginRenderPass& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandEndRenderPass& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDraw& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDrawIndirect& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatchMesh& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatchMeshIndirect& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBeginDebugLabel& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandEndDebugLabel& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBuildRayTracingBottomLevelAccelerationStructure& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandBuildRayTracingTopLevelAccelerationStructure& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatchRays& command);
        bool TranslateRenderBackendCommand(const RenderBackendCommandDispatchSuperSampling& command);
    private:
