...
namespace Horizon
{
    ...
    public:
        ...
        void DrawIndirect(RenderBackendShaderHandle vertexShader, RenderBackendShaderHandle pixelShader, const RenderBackendGraphicsPipelineState& graphicsPipelineState, const RenderBackendShaderConstants& shaderConstants, RenderBackendBufferHandle argumentBuffer, uint64 argumentBufferOffset, uint32 drawCount, RenderBackendPrimitiveTopology topology);
