...
struct PathTracingRendererUniformVariables
{
    uint frameIndex;
    uint frameIndexMod8;
    uint renderWidth;
...
#ifndef __cplusplus
//DECLARE_ALIASED_ARRAY_CONSTANT_BUFFER_CBV(PathTracingRendererUniformVariables);
DECLARE_ALIASED_ARRAY_STRUCTURED_BUFFER_SRV(PathTracingRendererUniformVariables);
#endif

#ifdef __cplusplus
static_assert(sizeof(PathTracingRendererUniformVariables) % 16 == 0);
#endif
