...
namespace Horizon
{
        ...
        const SceneView& view)
    {
        ...
        renderGraph.AddPass(
            ...
            {
                RenderGraphTextureHandle debugVisualizationTexture = builder.ReadTexture(intermediateResources.cascadedShadowMapDebugVisualizationTexture, RenderBackendResourceState::ShaderResource);
