...
#define HORIZON_OVERLOAD_ENUM_CLASS_OPERATORS(EnumClass) inline constexpr EnumClass& operator|=(EnumClass& lhs, EnumClass rhs)   { return lhs = (EnumClass)((__underlying_type(EnumClass))lhs | (__underlying_type(EnumClass))rhs); } \
