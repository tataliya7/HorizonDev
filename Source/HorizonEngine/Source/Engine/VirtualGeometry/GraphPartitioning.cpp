...
namespace Horizon::GraphPartitioning
{
    ...
    {
        idx_t nvtxs = static_cast<idx_t>(graph.nodeCount);
        idx_t ncon = 1;
        ...
        int result = METIS_PartGraphKway(
            ...
            partitionIndices);    // This is a vector of size nvtxs that upon successful completion stores the partition vector of the graph.
