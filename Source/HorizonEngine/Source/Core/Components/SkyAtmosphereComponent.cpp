...
namespace Horizon
{
    static void SetupAtmosphereOfEarth(SkyAtmosphereComponent* component)
    {
        ...
        const float earthAtmosphereHeight = 60.0f;
        ...
        // Raleigh
        const Vector3 earthRayleighScattering = Vector3(0.005802f, 0.013558f, 0.033100f);
        ...
        // Mie
        const Vector3 earthMieScattering = Vector3(0.003996f, 0.003996f, 0.003996f);
        const Vector3 earthMieExtinction = Vector3(0.004440f, 0.004440f, 0.004440f);
        const Vector3 earthMieAbsorption = earthMieExtinction - earthMieScattering;
        ...
        // Ozone
        const Vector3 earthAbsorptionExtinction = Vector3(0.000650f, 0.001881f, 0.000085f);
